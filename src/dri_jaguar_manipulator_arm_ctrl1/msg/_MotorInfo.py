"""autogenerated by genpy from dri_jaguar_manipulator_arm_ctrl1/MotorInfo.msg. Do not edit."""
import sys
...
class MotorInfo(genpy.Message):
  _md5sum = "0d28cdf51f23f2116287ecffabee4644"
  _type = "dri_jaguar_manipulator_arm_ctrl1/MotorInfo"
...
"""
  __slots__ = ['header','motorID','encoder_pos','encoder_vel','motor_temperature','motor_pwm']
  _slot_types = ['std_msgs/Header','uint32','int32','int32','float32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,motorID,encoder_pos,encoder_vel,motor_temperature,motor_pwm
